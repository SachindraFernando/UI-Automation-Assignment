...
public class CheckBoxPage extends PageBase {
    ...
    public static boolean isCheckBox1Displayed() { return getDriver().findElement(checkBox1).isDisplayed(); }
    ...
    public static boolean isCheckBox1Checked() { return getDriver().findElement(checkBox1).isSelected(); }

    public static boolean isCheckBox2Displayed() { return getDriver().findElement(checkBox2).isDisplayed(); }
    ...
    public static boolean isCheckBox2Checked() { return getDriver().findElement(checkBox2).isSelected(); }
}
